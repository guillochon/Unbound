...
subroutine Driver_evolveFlash()
  ...
  use User_interface, ONLY : User_updateEnvelopeComposition, &
                             User_calculateAtmosphere
...
!!******************************************************************************
  ...
  do dr_nstep = dr_nbegin, dr_nend
     ...
     ! Calculate envelope's composition, added by JFG.
     call User_updateEnvelopeComposition(blockCount, blockList)
